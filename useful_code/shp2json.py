...
if __name__ == '__main__':
    ...
    scale, stride = 512, 512

    train_test_scale = 1 / 6  # 验证集占全体比例

    tif_img_path = r'I:\data\preliminary/train/image'  # tif文件所在的文件夹
    shp_label_path = r'I:\data\preliminary/train/label'  # tif文件所在的文件夹
    train_img_path = r'I:\data\preliminary/train/{data_root}/train'  # 数据集train文件夹
    test_img_path = r'I:\data\preliminary/train/{data_root}/test'  # 数据集test文件夹
    json_path = r'I:\data\preliminary/train/{data_root}/annotations'  # train.json的路径
