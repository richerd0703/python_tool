...
def DoGreenLandIndexExtraction(pInputTSImage, pDays, nImageSize, pInPlotVec, pResultCSV):
    ...
    lib.DoGreenLandIndexExtractionSHP(pInputTSImage.encode("UTF-8"), pDays, nImageSize, pInPlotVec.encode("UTF-8"),
                                 pResultCSV.encode("UTF-8"))
...
if __name__ == '__main__':
    ...
    # csv_path = r"F:\wd_data\dll_tool\Data\out\20\20.csv"
    out_shp = r"F:\wd_data\dll_tool\Data\out\20\20.shp"
    DoGreenLandIndexExtraction(pInput, pDays, nImageSize, shp_path, out_shp)  # 20 ok
