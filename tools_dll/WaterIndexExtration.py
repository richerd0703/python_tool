...
def DoWaterIndexExtration(pInputTSImage, pDays, nImageSize, pInPlotVec, pResultCSV):
    ...
    lib.DoWaterIndexExtrationSHP(pInputTSImage.encode("UTF-8"), pDays, nImageSize, pInPlotVec.encode("UTF-8"),
                            pResultCSV.encode("UTF-8"))
...
if __name__ == '__main__':
    ...
    # csv_path = r"F:\wd_data\dll_tool\Data\out\19\19.csv"
    out_shp = r"F:\wd_data\dll_tool\Data\out\19\19.shp"

    DoWaterIndexExtration(pInput, pDays, nImageSize, shp_path, out_shp)  # 19 ok
